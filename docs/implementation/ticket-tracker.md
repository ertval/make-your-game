...
- [x] **C-04** P2 - Pause & Level Progression Systems — READY_FOR_MAIN: PARTIAL (SYSTEM LAYER COMPLETE); C-04 ECS systems implemented. Integration, UI, and runtime behavior handled in later tickets. Runtime integration, restart reset, and full audit PASS remain deferred to integration/UI tracks (Depends on: D-01, D-03, C-02, A-03, A-11 audit gate, non-blocking) | Blocks: A-05; A-06; A-08; B-09; C-05; A-12
