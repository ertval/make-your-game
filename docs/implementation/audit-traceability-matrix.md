...
| REQ-05 | HUD shows score and score increments | C-01, C-05, A-06 | AUDIT-F-15 | `tests/unit/systems/scoring-system.test.js` | Mapped, Covered, Partially Executable (system logic only — HUD/runtime pending C-05) |
...
| AUDIT-F-15 | Does score increase on scoring actions? | REQ-05 | Fully Automatable | C-01, C-05 | `tests/unit/systems/scoring-system.test.js` | Mapped, Covered, Partially Executable (system logic only — HUD/runtime pending C-05) |
