...
| AUDIT-F-05 | Does the game avoid the use of frameworks? | REQ-12 | Fully Automatable | A-01 | `tests/e2e/audit/audit.browser.spec.js` + static scan dependency check | Mapped, Planned, Executable |
...
| ID | Audit Question | Requirement IDs | Execution Type | Owning Tickets (`docs/implementation/track-*.md`) | Test/Evidence Anchor | Status |
|---|---|---|---|---|---|---|
| AUDIT-B-01 | Does project run quickly and effectively? | REQ-01 | Fully Automatable | A-06, D-08, A-09 | `tests/e2e/audit/audit.e2e.test.js` + [AUDIT-F-17-F-18.performance.md](../audit-reports/evidence/AUDIT-F-17-F-18.performance.md) | Mapped, Planned, Executable |
